...
If you prefer the repository root entry point, run `build.cmd`. It runs the aggregate `forge-port` build for all subprojects with tests and verification enabled, then copies the runtime jar to your Desktop.
